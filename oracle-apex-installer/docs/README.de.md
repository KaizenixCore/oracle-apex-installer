...
<h3>
  ...
  Automatisiert • Sicher • Docker-basiert • Produktionsbereit
  <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Gear.png" width="20"/>
</h3>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Lizenz-MIT-green?style=for-the-badge" alt="License"/>
...
**Oracle APEX Ultimate Installer** ist ein hochmodernes Bash-Skript, das die Bereitstellung von **Oracle APEX**, **ORDS** und **Oracle Database XE 21c** vollständig automatisiert.

Mit Docker erstellt es eine isolierte Umgebung und behandelt automatisch komplexe Konfigurationen wie **Fehler 571**-Patches und **Proxy-Authentifizierung** – spart Ihnen Stunden manueller Einrichtung!
...
<table>
  <tr>
    ...
    <td align="center" width="25%">
      ...
      <b>🐧 Multi-Distro</b><br>
      <sub>Funktioniert auf jedem Linux</sub>
    </td>
  </tr>
</table>
</div>
...
Nach Abschluss der Installation verwenden Sie diese Anmeldedaten:
...
| :---: | :--- | :--- |
| 🟢 **Starten** | `bash scripts/start.sh` | Startet Datenbank- und ORDS-Dienste |
| 🔴 **Stoppen** | `bash scripts/stop.sh` | Stoppt alle Container und Dienste |
| 📊 **Status** | `bash scripts/status.sh` | Überprüft DB- und ORDS-Zustand |
| 🔧 **Reparieren** | `bash scripts/fix.sh` | Führt umfassende Reparaturtools aus |
| 📜 **Protokolle** | `bash scripts/logs.sh` | Zeigt Live-Protokolle an |
...
| Schritt 1: Installation starten | Schritt 2: Komponenten installieren | Schritt 3: Installation abgeschlossen |
| :---: | :---: | :---: |
| ![Start](../assets/screenshots/install-1.png) | ![Fortschritt](../assets/screenshots/install-2.png) | ![Fertig](../assets/screenshots/install-3.png) |
...
| :--- | :---: | :---: |
| **🖥️ Betriebssystem** | Linux (beliebige Distribution) | Ubuntu 22.04 / openSUSE |
| **🐳 Docker** | v20.10+ | v24.0+ |
...
<p>
  <i>Wenn dieses Projekt Ihnen Zeit gespart hat, unterstützen Sie bitte seine Entwicklung!</i>
</p>
...
<a href="https://daramet.com/KaizenixCore">
  <img src="https://img.shields.io/badge/💖_Sponsor_auf_Daramet-FF6B6B?style=for-the-badge" alt="Sponsor"/>
</a>
&nbsp;&nbsp;
<a href="https://daramet.com/KaizenixCore">
  <img src="https://img.shields.io/badge/☕_Kaffee_spendieren-FFDD00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black" alt="Kaffee"/>
</a>
&nbsp;&nbsp;
<a href="https://github.com/KaizenixCore/oracle-apex-installer/stargazers">
  <img src="https://img.shields.io/badge/⭐_Stern_geben-181717?style=for-the-badge&logo=github" alt="Stern"/>
</a>
...
<table>
  <tr>
    <td align="center" width="33%">
      ...
      <sub><a href="https://daramet.com/KaizenixCore">Über Daramet spenden</a></sub>
    </td>
    <td align="center" width="33%">
    ...
    <td align="center" width="33%">
      ...
      <sub><a href="https://github.com/KaizenixCore/oracle-apex-installer/pulls">Pull Request einreichen</a></sub>
    </td>
  </tr>
</table>
...
<a href="https://github.com/KaizenixCore/oracle-apex-installer/issues">
  <img src="https://img.shields.io/badge/Fehler_melden-DC3545?style=for-the-badge&logo=github&logoColor=white" alt="Fehler"/>
</a>
&nbsp;
<a href="https://github.com/KaizenixCore/oracle-apex-installer/discussions">
  <img src="https://img.shields.io/badge/Diskussionen-5865F2?style=for-the-badge&logo=github&logoColor=white" alt="Diskussionen"/>
</a>
&nbsp;
<a href="https://daramet.com/KaizenixCore">
  <img src="https://img.shields.io/badge/Spenden-FF6B6B?style=for-the-badge&logo=heart&logoColor=white" alt="Spenden"/>
</a>
...
<sub>
  © 2024 <b>KaizenixCore</b> • Veröffentlicht unter der <b>MIT-Lizenz</b>
  <br><br>
